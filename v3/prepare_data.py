...
def txt_embender(training_data, col = 'recipeName'):
    ...
    df_emb.to_parquet(f'/Users/nicola.menale/Desktop/recepy_random_forest_classifier/emb_data/{col}_emb.parquet')
    return df_emb

training_data = import_training_data()
recipe_emb = txt_embender(training_data, col = 'recipe_full_text')